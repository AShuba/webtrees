...
/**
 * Test harness for the class CensusOfDenmark1911
 */
class CensusOfDenmark1911Test extends \PHPUnit_Framework_TestCase {
	/**
	 * Test the census place and date
	 *
	 * @covers \Fisharebest\Webtrees\Census\CensusOfDenmark1911
	 */
	public function testPlaceAndDate() {
		$census = new CensusOfDenmark1911;

		$this->assertSame('Danmark', $census->censusPlace());
		$this->assertSame('01 FEB 1911', $census->censusDate());
	}
