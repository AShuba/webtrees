...
/**
 * Test harness for the class CensusOfScotland1841
 */
class CensusOfScotland1841Test extends \PHPUnit_Framework_TestCase {
	/**
	...
	public function testColumns() {
		...
		$this->assertSame('EIF', $columns[5]->abbreviation());
		...
		$this->assertSame('Born in England, Ireland or foreign parts', $columns[5]->title());
	}
}
